    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="../images/Bidasari.jpg" alt="Your Photo" class="block h-12 w-auto fill-current text-gray-800 rounded-full">
                    </a>
                </div>
            ...
            <div class="shrink-0 flex items-center justify-center sm:justify-start">
                <button id="playNowButton" class="relative cursor-pointer opacity-90 hover:opacity-100 transition-opacity p-[2px] bg-black rounded-[16px] bg-gradient-to-t from-[#8122b0] to-[#dc98fd] active:scale-95">
